        ...
        <div class="container">
            ...
            <div class="row pt-5">
                <div class="col-md-12 pt-4">
                    ...
                    <form action="<?php echo base_url('Packet/redeem_amount') ?>" method="post" class="needs-validation" novalidate>
                        <div class="pt-3 user">
                            <label class="form-label">UPI ID</label>
                            <div>
                                <input type="text" autocomplete="off" id="upi" class="form-control new-form" placeholder="Enter UPI ID" name="upi" required="">
                            </div>
                        </div>
                        ...
                        <h4>Total Amount: <?php echo $total_amount; ?> Rs.</h4>
